...
<body>
	...
	<div class="topContent">
		...
		<div class="summary">
			...
			<!-- link -->
			<div class="link">
				<a href="https://m.hanabank.com/cont/mybranch/0978/03/MYB09780016180/index.html" class="round green"><span>한도 조회 하기</span></a>
			</div>
			<!-- //link -->
		</div>
		<!-- //summary -->
			...
			<li>
				...
				<div class="content">
					<div class="con">
						...
						<ul class="dotList">
							<li>하나은행으로부터 1Q오토론을 이용하여 자동차를 구매한 고객이 대출실행일로부터 1년 이내에 아래 조건에 해당하는 교통사고로 본인 신체 상해 발생한 경우 보험혜택이 제공됩니다. <br>
							*1Q오토론 신차구입자금 한정</li>
						</ul>
					</div>
					<div class="con">
						...
						<ul class="dotList">
							<li>피보험자(1Q오토론대출 차주 본인)가 보험기간 중 차량 탑승 중 교통재해를 직접적인 원인으로 장해분류표에서 정한 장해지급률이 3%이상 100%이하의 장해상태가 되었을때 1,000만원 * 해당장해지급률로 지급합니다.</li>
						</ul>
					</div>
					<div class="con">
					...
					<div class="con">
						<p class="title">유의사항</p>
						<ul class="dotList">
							<li>보험기간 중 피보험자(1Q오토론 대출차주 본인)의 사망으로 인하여 이 약관에서 규정하는 보험금 지급사유가 더 이상 발생할 수 없는 경우에는 이 보험계약은 그때부터 효력이 없습니다.</li>
						...
						<ul class="dotList">
							...
							<li class="reference">하나은행 준법감시인 심의필 제2022-광고-6269 호 (2022.08.12)</li>
	...
	<div class="bottomLink">
		<a href="https://m.hanabank.com/cont/mybranch/0978/03/MYB09780016180/index.html" class="box red"><span>한도 조회 하기</span></a>
	</div>
	<!-- //button -->
