			...
			<li>
				...
				<div class="content">
					<div class="con">
						...
						·오토캐쉬백 서비스 이용 후 특별한도 기간 내 별도 신청없이 자동차 판매 업종에서 추가로 결제하시면 300만원 이상 결제건 1.0%, 300만원 미만 결제건 0.5% 추가 캐시백이 적용됩니다. (단, 300만원 미만 결제건 중 체크방식은 제외) <br>
						...
						·준법심의 A-23-1407(2023.08.04 ~ 2024.08.03)
						</p>
					</div>
				</div>
			</li>
