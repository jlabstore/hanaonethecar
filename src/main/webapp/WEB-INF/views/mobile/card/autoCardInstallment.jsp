			...
			<li>
				...
				<div class="content">
					<div class="con">
						...
						· 오토카드할부 이용금액은 카드별 기본 서비스(포인트, 캐쉬백, 마일리지, 청구 할인 등)가 제공되지 않습니다. <br>
						· 오토카드할부는 하나카드 개인신용평점 기준에 따른 우수신용고객에 한해 이용가능한 상품입니다.<br>
						...
						&nbsp[준법심의필 A-23-0057(2023.01.17 ~ 2024.01.16)]
					</div>
				</div>
			</li>
			<!-- //유의사항 -->
