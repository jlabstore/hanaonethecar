	...
	<div class="detailContent">
		...
		<ul class="accordion">
			...
			<li>
				...
				<div class="content">
					<div class="con">
						<p class="text">· 금리인하요구권 및 대출계약 철회권에 대한 자세한 사항은 홈페이지에서 확인하시기 바랍니다.<br>
						· 오토론 관련 자세한 사항은 자동차금융 상담센터(1800-1221)로 문의 주시기 바랍니다. <br>
						· 해당 상품은 취급수수료가 없습니다.<br>
						· 대출취급일로부터 3년 이내 상환 시 잔여대출기간에 따라 상환 원금의 2% 이내로 중도상환수수료가 발생됩니다. <br>
						...
						<strong>· 상환능력에 비해 대출금이 과도할 경우 귀하의 개인신용평점이 하락할 수 있습니다.</strong> <br>
						<strong>· 개인신용평점 하락 시 금융거래와 관련된 불이익이 발생할 수 있습니다.</strong> <br>
						<strong>· 일정기간 원리금을 연체할 경우, 모든 원리금을 변제할 의무가 발생할 수 있습니다.</strong> <br>
						<strong>· 연체이자율(약정이율+최대3%)은 회원별.이용상품별로 차등 적용되며, 법정 최고금리(20%)이내에서 적용됩니다.</strong> <br>
						※ 여신금융협회 심의필 제 2024-L1h-02506호 (2024.02.29~2025.02.28)</p>
					</div>
				</div>
			</li>
			<!-- //유의사항 -->
