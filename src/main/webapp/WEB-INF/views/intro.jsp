...
<script>
	...
	(window,document,'script','dataLayer','GTM-KR4ZWSX');
</script>
<!-- Google tag (gtag.js) --> 
...
<section id="intro">
	...
	<div class="contents">
		...
		<!-- //qr code -->
		<!-- notify -->
		<p class="notify">하나은행은 예금자보호법상 부보금융기관이나 하나캐피탈, 하나카드는 부보금융기관이 아닙니다.<br>
			하나금융그룹 관계사는 상호 채무를 보증하지 않습니다<br>
			본 홍보물은 법령 및 내부통제기준에 따른 절차를 거쳐 제공됩니다. 본 홍보물은 2025년 8월 31일까지 유효합니다.<br>
			하나캐피탈 준법심의필 24-113(2024.09.09~2025.09.08) / 하나카드 준법심의A-24-2197(2024.09.04~2025.09.03)/ 준법감시인 심의필 제2023-광고-06828호(2023.10.05) / CC브랜드220811-0085
		</p>
		<p class="card-notify">
			<span>하나카드 유의사항</span><br/>
			...
			· 연체이자율(약정이율+최대3%)은 회원별.이용상품별로 차등 적용되며, 법정 최고금리(20%)이내에서 적용됩니다. <br/>
			· 준법심의A-24-2197(2024.09.04~2025.09.03)
